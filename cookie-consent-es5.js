  ...
  _createClass(CookieConsent, [{
    ...
    value: function createListItem(counter, listElement, id, name, url) {
      ...
      acceptButton.addEventListener('click', function () {
        _this2.switchAcceptPrivacyPolicyButton(id, counter);
      });
    ...
    key: "switchAcceptPrivacyPolicyButton",
    value: function switchAcceptPrivacyPolicyButton(id, counter) {
    ...
    key: "createButton",
    value: function createButton(id, name, action) {
      var _this3 = this;
      ...
      button.onclick = function () {
        ...
        if (action === 'accept' && _this3.listOfAcceptedVendors.length == 0) {
